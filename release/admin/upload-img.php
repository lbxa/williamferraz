            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php
                            if (isset($_GET['edit'])) {
                                $edited_img_id = trim(filter_input(INPUT_GET, 'edit', FILTER_SANITIZE_NUMBER_INT));
                                include_once('elements/forms/img_edit.form.php');
                            } else {
                                include_once("elements/forms/img_upload.form.php");
                            }
                        ?>
                        </div>
                    </div>
